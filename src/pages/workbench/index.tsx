...
const mockData = {
  statistics: [
    { title: "今日访问", value: "1,256", icon: <UserOutlined />, trend: "+12.5%" },
    { title: "待处理订单", value: "89", icon: <ShoppingOutlined />, trend: "+8.3%" },
    { title: "本月收入", value: "¥89.6万", icon: <DollarOutlined />, trend: "+15.6%" },
    { title: "完成率", value: "89.5%", icon: <TrophyOutlined />, trend: "+3.2%" },
  ],
  quickActions: [
    { key: "/sdk-demo", title: "SDK 演示", desc: "查看 SDK 使用示例", icon: <ApiOutlined /> },
    { key: "/dashboard", title: "数据看板", desc: "查看业务数据统计", icon: <DashboardOutlined /> },
    { key: "/data-screen", title: "数据大屏", desc: "可视化数据展示", icon: <BarChartOutlined /> },
    { key: "https://open.lovrabet.com", title: "查看文档", desc: "访问完整文档", icon: <FileTextOutlined />, external: true },
  ],
  recentAccess: [
  ...
  todos: [
    { title: "完成 SDK 集成文档", priority: "高", status: "pending", date: "2025-01-15" },
    { title: "优化数据大屏性能", priority: "中", status: "progress", date: "2025-01-20" },
    { title: "更新 API 文档", priority: "低", status: "pending", date: "2025-01-25" },
  ],
  announcements: [
    { title: "SDK v1.1.22 版本发布", content: "新增 filter 接口支持，支持复杂条件查询", time: "2025-01-10" },
    { title: "CLI v1.1.15 版本更新", content: "优化菜单同步功能，支持中文菜单名", time: "2025-01-08" },
    { title: "文档中心更新", content: "新增 API 使用指南和最佳实践", time: "2025-01-05" },
  ],
};
...
const Workbench: React.FC = () => {
  ...
  const getStatusIcon = (status: string) => {
    if (status === "done") return <CheckCircleOutlined style={{ color: "#34c759" }} />;
    if (status === "progress") return <ClockCircleOutlined style={{ color: "#007aff" }} />;
